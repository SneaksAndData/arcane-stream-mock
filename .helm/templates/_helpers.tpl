...
*/}}
{{- define "app.clusterRole.testStreamViewer" -}}
{{- if .Values.rbac.clusterRole.testStreamViewer.nameOverride }}
{{- .Values.rbac.clusterRole.testStreamViewer.nameOverride }}
{{- else }}
...
*/}}
{{- define "app.clusterRole.testStreamEditor" -}}
{{- if .Values.rbac.clusterRole.testStreamEditor.nameOverride }}
{{- .Values.rbac.clusterRole.testStreamEditor.nameOverride }}
{{- else }}
