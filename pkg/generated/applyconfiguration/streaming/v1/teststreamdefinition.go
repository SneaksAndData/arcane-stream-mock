...
func (b *TestStreamDefinitionApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *TestStreamDefinitionApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *TestStreamDefinitionApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *TestStreamDefinitionApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *TestStreamDefinitionApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *TestStreamDefinitionApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
