...
import (
	...
	apisstreamingv1 "github.com/SneaksAndData/arcane-stream-mock/pkg/apis/streaming/v1"
	...
	streamingv1 "github.com/SneaksAndData/arcane-stream-mock/pkg/generated/listers/streaming/v1"
...
type TestStreamDefinitionInformer interface {
	...
	Lister() streamingv1.TestStreamDefinitionLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.StreamingV1().TestStreamDefinitions(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StreamingV1().TestStreamDefinitions(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StreamingV1().TestStreamDefinitions(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StreamingV1().TestStreamDefinitions(namespace).Watch(ctx, options)
			},
		}, client),
		&apisstreamingv1.TestStreamDefinition{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *testStreamDefinitionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisstreamingv1.TestStreamDefinition{}, f.defaultInformer)
}

func (f *testStreamDefinitionInformer) Lister() streamingv1.TestStreamDefinitionLister {
	return streamingv1.NewTestStreamDefinitionLister(f.Informer().GetIndexer())
}
